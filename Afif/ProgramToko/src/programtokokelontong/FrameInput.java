...
public class FrameInput extends javax.swing.JFrame {
    double nama,harga,jmlBarang,total;
    int a = 0;
    ModelPenyimpanan penyimpanan = new ModelPenyimpanan();
    /**
     * Creates new form FrameInput
     */
    public FrameInput() {
        initComponents();
        tblPenjualan.setModel(penyimpanan.getTable());
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Program Penjualan Toko");
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        // TODO add your handling code here:
          ...
          jmlBarang = Integer.parseInt(txtJumlah.getText());
          harga = Integer.parseInt(txtHarga.getText());
          total = (int) (jmlBarang * harga);
          data[4] = String.valueOf(total);
          
          penyimpanan.getTable().addRow(data);
    }//GEN-LAST:event_btnSimpanActionPerformed

    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        // TODO add your handling code here:
        penyimpanan.getTable().removeRow(tblPenjualan.getSelectedRow());
